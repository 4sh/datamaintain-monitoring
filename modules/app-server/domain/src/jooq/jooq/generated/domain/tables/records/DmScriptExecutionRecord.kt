...
open class DmScriptExecutionRecord() : UpdatableRecordImpl<DmScriptExecutionRecord>(DmScriptExecution.DM_SCRIPT_EXECUTION), Record8<UUID?, OffsetDateTime?, OffsetDateTime?, Int?, String?, ScriptExecutionStatus?, String?, UUID?> {
    ...
    open var status: ScriptExecutionStatus?
        set(value): Unit = set(5, value)
        get(): ScriptExecutionStatus? = get(5) as ScriptExecutionStatus?
    ...
    public override fun valuesRow(): Row8<UUID?, OffsetDateTime?, OffsetDateTime?, Int?, String?, ScriptExecutionStatus?, String?, UUID?> = super.valuesRow() as Row8<UUID?, OffsetDateTime?, OffsetDateTime?, Int?, String?, ScriptExecutionStatus?, String?, UUID?>
    ...
    public override fun field6(): Field<ScriptExecutionStatus?> = DmScriptExecution.DM_SCRIPT_EXECUTION.STATUS
    ...
    public override fun component6(): ScriptExecutionStatus? = status
    ...
    public override fun value6(): ScriptExecutionStatus? = status
    ...
    public override fun value6(value: ScriptExecutionStatus?): DmScriptExecutionRecord {
        set(5, value)
        return this
    }
    ...
    public override fun values(value1: UUID?, value2: OffsetDateTime?, value3: OffsetDateTime?, value4: Int?, value5: String?, value6: ScriptExecutionStatus?, value7: String?, value8: UUID?): DmScriptExecutionRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: UUID? = null, startDate: OffsetDateTime? = null, endDate: OffsetDateTime? = null, durationInMs: Int? = null, output: String? = null, status: ScriptExecutionStatus? = null, fkScriptRef: String? = null, fkBatchExecutionRef: UUID? = null): this() {
        this.id = id
     ...
     * Create a detached, initialised DmScriptExecutionRecord
     */
    constructor(value: jooq.generated.domain.tables.pojos.DmScriptExecution?): this() {
        if (value != null) {
            this.id = value.id

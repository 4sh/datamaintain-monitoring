...
class BatchExecutionService(private val batchExecutionDao: BatchExecutionDaoInterface) {
    fun insert(data: BatchExecutionCreationRequest): BatchExecution = batchExecutionDao.insert(data)

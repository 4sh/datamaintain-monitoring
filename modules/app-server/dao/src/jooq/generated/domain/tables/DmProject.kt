...
import generated.domain.keys.DM_BATCH_EXECUTION_COUNTER__DM_BATCH_EXECUTION_COUNTER_FK_PROJECT_REF_FKEY
...
import generated.domain.tables.DmBatchExecutionCounter.DmBatchExecutionCounterPath
...
open class DmProject(
    ...
    private lateinit var _dmBatchExecutionCounter: DmBatchExecutionCounterPath

    /**
     * Get the implicit to-many join path to the
     * <code>public.dm_batch_execution_counter</code> table
     */
    fun dmBatchExecutionCounter(): DmBatchExecutionCounterPath {
        if (!this::_dmBatchExecutionCounter.isInitialized)
            _dmBatchExecutionCounter = DmBatchExecutionCounterPath(this, null, DM_BATCH_EXECUTION_COUNTER__DM_BATCH_EXECUTION_COUNTER_FK_PROJECT_REF_FKEY.inverseKey)

        return _dmBatchExecutionCounter;
    }

    val dmBatchExecutionCounter: DmBatchExecutionCounterPath
        get(): DmBatchExecutionCounterPath = dmBatchExecutionCounter()
